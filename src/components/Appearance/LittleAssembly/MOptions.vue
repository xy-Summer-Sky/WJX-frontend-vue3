<template>
  <div class="Default" v-show="showDe">
    <el-checkbox :label="OptionName">{{ OptionName }}</el-checkbox>
  </div>
  <div class="Edit" v-show="showEd">
    <el-checkbox :label="OptionName">
      <el-input
        v-model="OptionName"
...
export default {
  ...
  data() {
    return {
      showDe: this.showDE,
      showEd: this.showED,
      OptionName: "选项" + this.NumberofOption + "",
    };
  },
  methods: {
    Add() {
